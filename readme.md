...
2. **⚙️ Modélisation** : Entraînement d'un modèle de **Régression Linéaire** avec affichage des coefficients pour garantir l'explicabilité de l'IA.
3. **🔮 Prédiction** : Interface de saisie utilisateur avec validation des entrées pour estimer les frais en temps réel.

## 🔒 Sécurité et Conformité (Points clés du TP)
...
└── utils/
    └── model_utils.py    # Fonctions de nettoyage (Preprocessing)